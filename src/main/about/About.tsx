                    ...
                    <div className={'about-wrapper'}>
                        ...
                        <div className={'about-description-container main-typography'}>
                            ...
                            <p className={'about-description'}>
                                ...
                                malesuada viverra tempus nunc urna. Amet netus arcu eget tincidunt sodales. Et libero
                                vitae mattis dolor tellus mauris netus nibh imperdiet. Ridiculus eu ultricies et cras
                                nunc pellentesque.
                            </p>
                        </div>
