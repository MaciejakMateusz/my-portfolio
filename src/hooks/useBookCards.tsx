...
export const useBookCards = (): JSX.Element[] => {
    ...
    return [
        ...
        <BookCard key={'designPatterns'}
                  title={t('designPatterns')}
